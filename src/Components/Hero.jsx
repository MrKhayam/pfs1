  ...
  return (
    <>
      <div className="md:w-[90%] w-full p2 h-full mx-auto flex md:flex-row flex-col-reverse md:items-center md:justify-between justify-center">
        <div className="left w-full md:w-1/2 mt-3 md:block flex flex-col items-center">
          ...
          <div className="btns md:w-full w-[90%] mt-3 md:mt-0 flex md:flex-row flex-col gap-3 items-center">
